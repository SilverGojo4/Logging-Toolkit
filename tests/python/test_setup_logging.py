...
def test_setup_logging():
    ...
    file_config_path = os.path.join(BASE_PATH, "src/python/file_logging.json")
    error_config_path = os.path.join(BASE_PATH, "src/python/error_logging.json")

    # Dynamically adjust the output log paths
    file_log_path = os.path.join(BASE_PATH, "logs/file.log")
    ...
    file_logger = setup_logging(
        config_file=file_config_path,
        logger_name="file_logger",
        handler_name="file",
        output_log_path=file_log_path,
    )
    ...
    for log_path in [file_log_path, error_log_path]:
...
def test_setup_logging_with_divider():
    """
    Tests the setup_logging function for correct logger configuration and verifies the CustomLogger addDivider functionality.   # pylint: disable=line-too-long
    """
    # Use test configuration files
    file_config_path = os.path.join(BASE_PATH, "src/python/file_logging.json")
    error_config_path = os.path.join(BASE_PATH, "src/python/error_logging.json")
...
def test_log_with_borders():
    """
    Tests the log_with_borders method in CustomLogger for correct border formatting and message truncation. # pylint: disable=line-too-long
    """
    # Use test configuration files
    file_config_path = os.path.join(BASE_PATH, "src/python/file_logging.json")
    error_config_path = os.path.join(BASE_PATH, "src/python/error_logging.json")
